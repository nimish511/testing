...
if __name__ == '__main__':
    ...
    parser.add_argument('-t', '--token', default='08b66ae14518bbb16075e2a48de76a4b0d5f3ea0', help='Client token from the user account.')
    parser.add_argument('-d', '--dataset', default='testing/bjbfjbjf', help='Dataset to download.')
    parser.add_argument('-r', '--release', default='v0.3', help='Specific release of the dataset to download')
